...
///////////////////////////////////////////////////////////////////////////////////////////////////
	...
	public static String escogerPalabra() {
		...
		String vDiccionario[] = { "ABANDONO", "ABDOMEN", "ABRIGO", "ABUELA", "ABUELO", "ABURRIMIENTO", "ACCION",
				...
				"DINOSAURIO", "DIOS", "DIPUTADO", "DIRECCION", "DIRECTOR", "DOCUMENTO", "DOLOR", "DOMINGO",
				"DORMITORIO", "DOS", "DRAGON", "DUCHA", "DUDA", "DURAZNO", "ECONOMIA", "EDAD", "EDIFICIO", "EDUCACION",
				"EFECTO", "EJEMPLO", "ELECCION", "ELECTRICIDAD", "ELEFANTE", "ELEMENTO", "ELEVADOR", "EMPATIA",
				"EMPERADOR", "EMPERATRIZ", "EMPLEO", "EMPRESA", "ENAMORADO", "ENCUENTRO", "ENERGIA", "ENFADO",
				"ENFERMEDAD", "ENOJO", "ENTORNO", "ENTRADA", "ENTRESEMANA", "ENTRETENIMIENTO", "EPOCA", "EPOPEYA",
				"EQUIPO", "EQUIVOCACION", "ERA", "ERROR", "ESCALA", "ESCALERA", "ESCRITORIO", "ESCUELA", "ESCULTURA",
				"ESFUERZO", "ESPACIO", "ESPALDA", "ESPAÑOL", "ESPECIE", "ESPECTACULO", "ESPECTADOR", "ESPERA",
				"ESPINILLA", "ESPIRITU", "ESPOSA", "ESPOSO", "ESTACION", "ESTADO", "ESTE", "ESTILO", "ESTOMAGO",
				"ESTRELLA", "ESTRUCTURA", "ESTUDIO", "ETAPA", "EXISTENCIA", "EXITO", "EXPERIENCIA", "EXPRESION",
				"EXTASIS", "EXTERIOR", "FABRICA", "FALDA", "FALTA", "FAMILIA", "FASE", "FAVOR", "FECHA", "FERROCARRIL",
				"FIGURA", "FIN", "FINAL", "FLOR", "FONDO", "FORMA", "FORMACION", "FORMALIDAD", "FRACASO", "FRANCES",
				"FRENTE", "FRUTA", "FUEGO", "FUENTE", "FUERZA", "FUNCION", "FUTURO", "GAFAS", "GALAXIA", "GALLINA",
				"GAS", "GASEOSA", "GATO", "GENTE", "GEOGRAFIA", "GOBERNADOR", "GOBIERNO", "GORRION", "GRABADO", "GRADO",
				"GRAMO", "GRIPE", "GRIS", "GRUPO", "GUERRA", "GUISANTE", "HABITACION", "HALCON", "HERMANA", "HERMANO",
				"HIELO", "HIERRO", "HIGADO", "HIJA", "HIJO", "HILO", "HISTORIA", "HOGAR", "HOJA", "HOMBRE", "HOMBRO",
				"HONGO", "HORA", "HORTICULTURA", "HOTEL", "HOY", "HUESO", "HUMANIDAD", "HUMANO", "IDEA", "IDIOMA",
				"IMAGEN", "IMAN", "INFORMACION", "INFORME", "INGLES", "INICIO", "INSECTO", "INSTANTE", "INSTITUTO",
				"INTENDENTE", "INTENTO", "INTERES", "INTERIOR", "INTERRUPCION", "INVESTIGACION", "IZQUIERDA", "JAPONES",
				"JIRAFA", "JUDIA", "JUEVES", "JUNGLA", "KILO", "KILOMETRO", "KIWI", "LABIO", "LADO", "LADRON",
				"LAGARTO", "LAGO", "LAGUNA", "LAMINA", "LANGOSTA", "LARGO", "LEÑA", "LEON", "LEY", "LIBERTAD", "LIBRO",
				"LITRO", "LLAVE", "LLAVERO", "LLUVIA", "LODO", "LOGRO", "LOMBRIZ", "LONGITUD", "LUGAR", "LUNA", "LUNES",
				"LUZ", "MADRE", "MANDARINA", "MANERA", "MANGA", "MANIQUI", "MANO", "MANZANA", "MAÑANA", "MAQUINA",
				"MAR", "MARIPOSA", "MARISCO", "MARRON", "MARTES", "MARTIR", "MATRIMONIO", "MAYORIA", "MEDIDA",
				"MEDIODIA", "MEJORA", "MEMORIA", "MENTE", "MENTIRA", "MERCADO", "MERCENARIO", "MES", "MESA", "MESILLA",
				"META", "METAL", "METALICO", "METRO", "MIEDO", "MIERCOLES", "MIL", "MILENIO", "MILIMETRO", "MILLON",
				"MINISTRO", "MINORIA", "MINUTO", "MODO", "MOLUSCO", "MOMENTO", "MONO", "MONTAÑA", "MONTE", "MOSCA",
				"MOSQUITO", "MOVIMIENTO", "MUERTE", "MUJER", "MULTICOLOR", "MUNDO", "MUNICIPIO", "MUÑECA", "MURCIELAGO",
				"MUSCULO", "MUSICA", "MUSLO", "NACIMIENTO", "NACION", "NADA", "NARANJA", "NARIZ", "NATURALEZA",
				"NECESIDAD", "NEGRO", "NEVERA", "NIETA", "NIETO", "NIEVE", "NIÑA", "NIÑO", "NIVEL", "NOCHE", "NOMBRE",
				"NORMA", "NORTE", "NOTICIA", "NUBLADO", "NUDO", "NUEVE", "NUEZ", "NUMERO", "OBJETIVO", "OBJETO",
				"OBLIGACION", "OBRA", "OCASION", "OCEANO", "OCHO", "OESTE", "OFERTA", "OFICINA", "OIDO", "OJO",
				"OLFATO", "OMNIBUS", "ORDEN", "ORDENADOR", "OREJA", "ORGANIZACION", "ORIGEN", "ORO", "ORQUESTA",
				"OVEJA", "PADRE", "PAIS", "PAJARO", "PALABRA", "PALMA", "PANEL", "PANTALLA", "PANTALON", "PAPA",
				...
				"PERIODICO", "PERIODISMO", "PERIQUITO", "PERJUICIO", "PERMISO", "PERRO", "PERSONA", "PERSONALIDAD",
				"PESO", "PEZ", "PIE", "PIEL", "PIERNA", "PINO", "PINTURA", "PISO", "PLACER", "PLANETA", "PLANTA",
				"PLATA", "PLATANO", "PLAYA", "PLOMO", "POBLACION", "POLICIA", "POLILLA", "POLITICA", "POLITICO", "POMO",
				...
				"PRODUCCION", "PRODUCTO", "PROFESION", "PROGRAMA", "PROGRAMADOR", "PROGRESO", "PROHIBICION",
				"PROVINCIA", "PROYECTO", "PSIQUIATRICO", "PUEBLO", "PUERTA", "PULPO", "PUNTO", "QUIROFANO",
				"QUITANIEVES", "RABANO", "RAIZ", "RAMA", "RAMO", "RANA", "RATA", "RATON", "RAYO", "RAZON", "REALIDAD",
				"REBELDE", "RECUERDO", "REDUCCION", "REGION", "RELACION", "RELIGION", "REPRESENTANTE", "REPRODUCCION",
				"RESFRIADO", "RESPUESTA", "RESULTADO", "RETROCESO", "REUNION", "REVISTA", "RIO", "RODILLA", "ROJO",
				"ROPA", "ROSA", "ROSADO", "RUTA", "SABADO", "SACACORCHOS", "SAL", "SALTAMONTES", "SALUD", "SANDIA",
				"SANGRE", "SARDINA", "SARTEN", "SECRETO", "SECTOR", "SECUENCIA", "SEGUNDO", "SEGURIDAD", "SEIS",
				"SELVA", "SEMANA", "SEMILLA", "SENADOR", "SENSACION", "SENTIDO", "SEÑOR", "SEÑORA", "SER", "SERIE",
				"SERPIENTE", "SERVICIO", "SIETE", "SIGLO", "SIGNIFICADO", "SILLA", "SIMBOLO", "SIMILITUD", "SISTEMA",
				"SITUACION", "SOBRINA", "SOBRINO", "SOCIEDAD", "SOFA", "SOL", "SOLAPA", "SOLICITUD", "SOLUCION",
				"SORPRESA", "SOSTEN", "SUBTERRANEO", "SUELO", "SUGERENCIA", "SUJETADOR", "SUPERFICIE", "SUR", "SUSTO",
				"TACTO", "TALLO", "TALON", "TAMAÑO", "TARDE", "TARIFA", "TEMA", "TEMOR", "TERMOSTATO", "TERREMOTO",
				"TEXTO", "TIA", "TIEMPO", "TIERRA", "TIGRE", "TIO", "TIPO", "TODOTERRENO", "TOMATE", "TORMENTA",
				"TOTAL", "TRABAJO", "TRAFICO", "TRANCAR", "TRANSACCION", "TRANSCURSO", "TRANSITO", "TRANSPORTE",
				"TRAPECIO", "TRASERO", "TREN", "TRES", "TRIGO", "TRISTEZA", "TRUENO", "UNICORNIO", "UNIDAD",
