...
public class Javangman {
	...
	static String vDiccionario[] = { "ABANDONO", "ABDOMEN", "ABRIGO", "ABUELA", "ABUELO", "ABURRIMIENTO", "ACCION",
			...
			"ALBONDIGA", "ALCALDE", "ALEGRIA", "ALEMAN", "ALFABETO", "ALIMENTO", "ALMA", "ALMACEN", "ALMENDRA", "ALTO",
			"ALTURA", "ALUMNADO", "AMANECER", "AMAPOLA", "AMARILLO", "AMBIENTE", "AMBULANCIA", "AMIGA", "AMIGO", "AMOR",
			"ANALISIS", "ANARANJADO", "ANATOMIA", "ANCHO", "ANCIANO", "ANIMAL", "ANOCHECER", "AÑO", "APARATO",
			"APARTAMENTO", "APERITIVO", "APOYO", "ARAÑA", "ARBOL", "AREA", "ARITMETICA", "ARMA", "ARRIBA", "ARROZ",
			"ARTE", "ARTICULO", "ASCENSOR", "ASFALTO", "ASOCIACION", "ASPECTO", "ASTRONAUTA", "ATAQUE", "ATARDECER",
			"ATENCION", "ATMOSFERA", "ATUN", "AUMENTO", "AUTO", "AUTOBUS", "AUTOMOVIL", "AUTOPISTA", "AUTOR",
			"AUTORIDAD", "AVANCE", "AVENA", "AVENIDA", "AVION", "AYER", "AYUDA", "AZUL", "BABOSA", "BAMBU", "BARBA",
			"BARRO", "BASE", "BEBE", "BEBIDA", "BENEFICIO", "BICHO", "BIENVENIDA", "BIGOTE", "BILLETE", "BISABUELA",
			"BISABUELO", "BISNIETA", "BISNIETO", "BLANCO", "BOCA", "BOLETO", "BOLSA", "BOLSILLO", "BOLSO", "BOMBEROS",
			"BOMBILLA", "BOSQUE", "BOTON", "BRAGA", "BRAZO", "BROMISTA", "BUS", "BUSQUEDA", "CABALLERO", "CABALLO",
			"CABELLO", "CABEZA", "CABO", "CADERA", "CAFE", "CAFETERIA", "CALAMAR", "CALCETINES", "CALENDARIO",
			"CALIDAD", "CALLE", "CALOR", "CALZON", "CALZONCILLO", "CAMA", "CAMARA", "CAMARON", "CAMBIO", "CAMINO",
			"CAMION", "CAMISA", "CAMISETA", "CAMPAÑA", "CAMPO", "CAMUFLAJE", "CANICHE", "CANSANCIO", "CANTIDAD",
			"CAPACIDAD", "CAPITAL", "CARA", "CARACOL", "CARACTER", "CARACTERISTICA", "CARGO", "CARNE", "CARPA",
			"CARRERA", "CARRETERA", "CARTA", "CASA", "CASO", "CASTAÑA", "CASTAÑO", "CASTILLO", "CAUSA", "CAVERNA",
			"CEBADA", "CELESTE", "CENTIMETRO", "CERDO", "CEREBRO", "CERO", "CERRO", "CERVEZA", "CESPED", "CHAQUETA",
			"CHINO", "CHOCOLATE", "CHUBASQUERO", "CIELO", "CIEN", "CIENCIA", "CIENTO", "CIERRE", "CIERVO", "CINCO",
			"CINE", "CINTURA", "CINTURON", "CIRCENSE", "CIRUELA", "CIRUJANO", "CIUDAD", "CLASE", "CLAVO", "CLIMA",
			"CLUB", "COCHE", "COCODRILO", "COCOTERO", "CODIGO", "CODO", "COLA", "COLEGA", "COLEGIO", "COLOR", "COMA",
			"COMERCIO", "COMIDA", "COMIENZO", "COMISION", "COMPAÑIA", "COMPETENCIA", "COMPETICION", "COMPUTADORA",
			"COMUNICACION", "COMUNIDAD", "CONCEPTO", "CONCIENCIA", "CONDICION", "CONEJO", "CONEXION", "CONFIANZA",
			"CONFLICTO", "CONGRESISTA", "CONGRESO", "CONJUNTO", "CONOCIDA", "CONOCIDO", "CONOCIMIENTO", "CONSECUENCIA",
			"CONSEJO", "CONSTITUCION", "CONSTRUCCION", "CONSUMO", "CONTENIDO", "CONTROL", "CORAZON", "CORDEL", "CORDON",
			"CORRIENTE", "CORTE", "COSA", "COSTA", "CREACION", "CRECIMIENTO", "CREMA", "CREMALLERA", "CRIATURA",
			"CRISIS", "CUADRO", "CUARTO", "CUATRO", "CUCARACHA", "CUELLO", "CUENTA", "CUERDA", "CUERPO", "CUERVO",
			"CUESTION", "CULO", "CULTURA", "CURA", "CURSO", "DAMA", "DATO", "DECADA", "DECISION", "DECRETO", "DEDO",
			"DEFENSA", "DELTA", "DEMANDA", "DEMOCRACIA", "DEPARTAMENTO", "DEPORTE", "DERECHA", "DERECHO", "DESARROLLO",
			"DESCAPOTABLE", "DESEO", "DESIERTO", "DESPEJADO", "DESTINO", "DESTRUCCION", "DETERIORO", "DIA", "DIAGONAL",
			"DIARIO", "DIARREA", "DIBUJO", "DICCIONARIO", "DICTADURA", "DIENTE", "DIEZ", "DIFERENCIA", "DIMINUTO",
			"DINERO", "DINOSAURIO", "DIOS", "DImejoras mínimasPUTADO", "DIRECCION", "DIRECTOR", "DOCUMENTO", "DOLOR",
			"DOMINGO", "DORMITORIO", "DOS", "DRAGON", "DUCHA", "DUDA", "DURAZNO", "ECONOMIA", "EDAD", "EDIFICIO",
			"EDUCACION", "EFECTO", "EJEMPLO", "ELECCION", "ELECTRICIDAD", "ELEFANTE", "ELEMENTO", "ELEVADOR", "EMPATIA",
			"EMPERADOR", "EMPERATRIZ", "EMPLEO", "EMPRESA", "ENAMORADO", "ENCUENTRO", "ENERGIA", "ENFADO", "ENFERMEDAD",
			"ENOJO", "ENTORNO", "ENTRADA", "ENTRESEMANA", "ENTRETENIMIENTO", "EPOCA", "EPOPEYA", "EQUIPO",
			"EQUIVOCACION", "ERA", "ERROR", "ESCALA", "ESCALERA", "ESCRITORIO", "ESCUELA", "ESCULTURA", "ESFUERZO",
			"ESPACIO", "ESPALDA", "ESPAÑOL", "ESPECIE", "ESPECTACULO", "ESPECTADOR", "ESPERA", "ESPINILLA", "ESPIRITU",
			"ESPOSA", "ESPOSO", "ESTACION", "ESTADO", "ESTE", "ESTILO", "ESTOMAGO", "ESTRELLA", "ESTRUCTURA", "ESTUDIO",
			"ETAPA", "EXISTENCIA", "EXITO", "EXPERIENCIA", "EXPRESION", "EXTASIS", "EXTERIOR", "FABRICA", "FALDA",
			"FALTA", "FAMILIA", "FASE", "FAVOR", "FECHA", "FERROCARRIL", "FIGURA", "FIN", "FINAL", "FLOR", "FONDO",
			"FORMA", "FORMACION", "FORMALIDAD", "FRACASO", "FRANCES", "FRENTE", "FRUTA", "FUEGO", "FUENTE", "FUERZA",
			"FUNCION", "FUTURO", "GAFAS", "GALAXIA", "GALLINA", "GAS", "GASEOSA", "\n" + "	 GATO", "GENTE",
			"GEOGRAFIA", "GOBERNADOR", "GOBIERNO", "GORRION", "GRABADO", "GRADO", "GRAMO", "GRIPE", "GRIS", "GRUPO",
			"GUERRA", "GUISANTE", "HABITACION", "HALCON", "HERMANA", "HERMANO", "HIELO", "HIERRO", "HIGADO", "HIJA",
			"HIJO", "HILO", "HISTORIA", "HOGAR", "HOJA", "HOMBRE", "HOMBRO", "HONGO", "HORA", "HORTICULTURA", "HOTEL",
			"HOY", "HUESO", "HUMANIDAD", "HUMANO", "IDEA", "IDIOMA", "IMAGEN", "IMAN", "INFORMACION", "INFORME",
			"INGLES", "INICIO", "INSECTO", "INSTANTE", "INSTITUTO", "INTENDENTE", "INTENTO", "INTERES", "INTERIOR",
			"INTERRUPCION", "INVESTIGACION", "IZQUIERDA", "JAPONES", "JIRAFA", "JUDIA", "JUEVES", "JUNGLA", "KILO",
			"KILOMETRO", "KIWI", "LABIO", "LADO", "LADRON", "LAGARTO", "LAGO", "LAGUNA", "LAMINA", "LANGOSTA", "LARGO",
			"LEÑA", "LEON", "LEY", "LIBERTAD", "LIBRO", "LITRO", "LLAVE", "LLAVERO", "LLUVIA", "LODO", "LOGRO",
			"LOMBRIZ", "LONGITUD", "LUGAR", "LUNA", "LUNES", "LUZ", "MADRE", "MANDARINA", "MANERA", "MANGA", "MANIQUI",
			"MANO", "MANZANA", "MAÑANA", "MAQUINA", "MAR", "MARIPOSA", "MARISCO", "MARRON", "MARTES", "MARTIR",
			"MATRIMONIO", "MAYORIA", "MEDIDA", "MEDIODIA", "MEJORA", "MEMORIA", "MENTE", "MENTIRA", "MERCADO",
			"MERCENARIO", "MES", "MESA", "MESILLA", "META", "METAL", "METALICO", "METRO", "MIEDO", "MIERCOLES", "MIL",
			"MILENIO", "MILIMETRO", "MILLON", "MINISTRO", "MINORIA", "MINUTO", "MODO", "MOLUSCO", "MOMENTO", "MONO",
			"MONTAÑA", "MONTE", "MOSCA", "MOSQUITO", "MOVIMIENTO", "MUERTE", "MUJER", "MULTICOLOR", "MUNDO",
			"MUNICIPIO", "MUÑECA", "MURCIELAGO", "MUSCULO", "MUSICA", "MUSLO", "NACIMIENTO", "NACION", "NADA",
			"NARANJA", "NARIZ", "NATURALEZA", "NECESIDAD", "NEGRO", "NEVERA", "NIETA", "NIETO", "NIEVE", "NIÑA", "NIÑO",
			...
			"ORQUESTA", "OVEJA", "PADRE", "PAIS", "PAJARO", "PALABRA", "PALMA", "PANEL", "PANTALLA", "PANTALON", "PAPA",
			"PAPEL", "PARADA", "PARAGUAS", "PARASOL", "PARBULARIO", "PAREJA", "PARLAMENTARIO", "PARTE", "PARTIDO",
			"PASADO", "PASO", "PASTO", "PATA", "PATATA", "PAZ", "PECHO", "PENSAMIENTO", "PERA", "PERCEPCION",
			"PERIODICO", "PERIODISMO", "PERIQUITO", "PERJUICIO", "PERMISO", "PERRO", "PERSONA", "PERSONALIDAD", "PESO",
			"PEZ", "PIE", "PIEL", "PIERNA", "PINO", "PINTURA", "PISO", "PLACER", "PLANETA", "PLANTA", "PLATA",
			"PLATANO", "PLAYA", "PLOMO", "POBLACION", "POLICIA", "POLILLA", "POLITICA", "POLITICO", "POMO",
			"POSIBILIDAD", "POSICION", "POTENCIA", "POZO", "PRECIO", "PREGON", "PREGUNTA", "PRENDA", "PRESENCIA",
			"PRESENTE", "PRESIDENTE", "PRIMA", "PRIMO", "PRINCIPIO", "PROBABILIDAD", "PROBLEMA", "PROCESO",
			"PRODUCCION", "PRODUCTO", "PROFESION", "PROGRAMA", "PROGRAMADOR", "PROGRESO", "PROHIBICION", "PROVINCIA",
			"PROYECTO", "PSIQUIATRICO", "PUEBLO", "PUERTA", "PULPO", "PUNTO", "QUIROFANO", "QUITANIEVES", "RABANO",
			"RAIZ", "RAMA", "RAMO", "RANA", "RATA", "RATON", "RAYO", "RAZON", "REALIDAD", "REBELDE", "RECUERDO",
			"REDUCCION", "REGION", "RELACION", "RELIGION", "REPRESENTANTE", "REPRODUCCION", "RESFRIADO", "RESPUESTA",
			"RESULTADO", "RETROCESO", "REUNION", "REVISTA", "RIO", "RODILLA", "ROJO", "ROPA", "ROSA", "ROSADO", "RUTA",
			"SABADO", "SACACORCHOS", "SAL", "SALTAMONTES", "SALUD", "SANDIA", "SANGRE", "SARDINA", "SARTEN", "SECRETO",
			"SECTOR", "SECUENCIA", "SEGUNDO", "SEGURIDAD", "SEIS", "SELVA", "SEMANA", "SEMILLA", "SENADOR", "SENSACION",
			"SENTIDO", "SEÑOR", "SEÑORA", "SER", "SERIE", "SERPIENTE", "SERVICIO", "SIETE", "SIGLO", "SIGNIFICADO",
			"SILLA", "SIMBOLO", "SIMILITUD", "SISTEMA", "SITUACION", "SOBRINA", "SOBRINO", "SOCIEDAD", "SOFA", "SOL",
			"SOLAPA", "SOLICITUD", "SOLUCION", "SORPRESA", "SOSTEN", "SUBTERRANEO", "SUELO", "SUGERENCIA", "SUJETADOR",
			...
			"TRANSPORTE", "TRAPECIO", "TRASERO", "TREN", "TRES", "TRIGO", "TRISTEZA", "TRUENO", "UNICORNIO", "UNIDAD",
			"UNIVERSIDAD", "UNIVERSO", "UNO", "UÑA", "USO", "UTILIZACION", "VACA", "VALOR", "VAPOR", "VEGETAL",
			"VEHICULO", "VELOCIDAD", "VENTANA", "VENTILADOR", "VERDAD", "VERDE", "VERDURA", "VESTIDO", "VEZ", "VIA",
			"VIDA", "VIENTO", "VIERNES", "VILLA", "VIOLETA", "VIRUS", "VISTA", "VOLUMEN", "VOZ", "VUELTO", "YEGUA",
			"ZANAHORIA", "ZAPATILLA", "ZAPATO", "ZONA" };
...
//		System.out.println(" (" + palabra + ")");    	// Esto muestra la palabra al lado de vPalabraOculta.
	...
	public static void about() {
		...
		System.out.println("------------------------------");
		System.out.println("|        " + (vDiccionario.length + vDiccionarioPaises.length + vDiccionarioAstro.length) + " palabras       |");
