...
public class Metodos {
	...
	static String vDiccionarioAnimales[]= {"ABEJA","AGUILA","ALMEJA","ANTILOPE","ARAÑA","ARDILLA","ATUN","AVES","AVESTRUZ","AVISPA","BABOSA","BACALAO","BALLENA","BICHO","BOA","BUEY","BUFALO","BUITRE","BURRO","CABALLO","CABRA","CALAMAR","CAMARON","CAMELLO","CANARIO","CANGREJO","CANGURO","CARACOL","CASTOR","CEBRA","CENTOLLO","CERDO","CHIMPANCE","CIERVO","CIGARRA","CIGÜEÑA","CISNE","COCODRILO","CODORNIZ","COMADREJA","CONEJO","CORDERO","CRUSTACEO","CUCARACHA","CUERVO","DELFIN","DRAGON","DRAGON DE KOMODO","ELEFANTE","ERIZO","ERIZO DE MAR","ESCARABAJO","ESCORPION","FAISAN","FOCA","GACELA","GALLINA","GALLO","GAMBA","GARZA","GATO","GAVIOTA","GOLONDRINA","GORILA","GORRION","GRILLO","GUACAMAYO","GUSANO","HALCON","HIENA","HIPOPOTAMO","HORMIGA","INSECTO","JILGUERO","JIRAFA","LAGARTO","LANGOSTA","LECHUZA","LEON","LEOPARDO","LIEBRE","LINCE","LIRON","LLAMA","LOBO","LOMBRIZ","LORO","MAMIFERO","MARIPOSA","MARIQUITA","MARISCO","MARMOTA","MEJILLON","MIRLO","MOLUSCO","MONO","MOSCA","MOSQUITO","MURCIELAGO","NUTRIA","OCA","OSO","OSTRA","OVEJA","PAJARO","PAJARO CARPINTERO","PALOMA","PANTERA","PATO","PAVO","PAVO REAL","PELICANO","PERDIZ","PERIQUITO","PERRO","PEZ","POLILLA","POLLO","PULPO","RANA","RATA","RATON","RENO","REPTIL","RINOCERONTE","RUISEÑOR","SALMON","SALTAMONTES","SARDINA","SERPIENTE","TARANTULA","TERNERO","TIGRE","TORO","TORTUGA","TRUCHA","VACA","VIBORA","YEGUA","ZORRO"};
	...
	static int numCategorias=6, victoriasConsecutivas=0, record=0;
...
//		System.out.println(" (" + palabra + ")");    	// Esto muestra la palabra al lado de vPalabraOculta.
	...
	public static void about() {
		...
		System.out.println("\n ------------------------------");
		System.out.println(" | ACERCA DE  Javangman 2.1.0 |");
		System.out.println(" ------------------------------");
		System.out.println(" |        " + (vDiccionario.length + vDiccionarioPaises.length + vDiccionarioAstro.length + vDiccionarioAnimales.length + vDiccionarioInstrumentos.length + vDiccionarioEstados.length) + " palabras       |");
		System.out.println(" |    Programado con Java.    |");
		System.out.println(" |                            |");
		System.out.println(" |   Con la colaboración de   |");
